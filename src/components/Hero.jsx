...
const Hero = () => {
  return (
    <section className='relative w-full min-h-screen mx-auto flex flex-col justify-center items-center pt-[100px] sm:pt-[120px] pb-10 overflow-hidden'>
      <div className='max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10 px-6 z-10 w-full'>
        {/* Left side text */}
        <div className='flex flex-row items-start gap-5 flex-1 w-full'>
          ...
          <div className='w-full'>
            <h1 className='font-black text-white lg:text-[70px] sm:text-[55px] xs:text-[45px] text-[36px] lg:leading-[88px] mt-2'>
              Hi, I'm{" "}
              <span className='text-[#915EFF]'>Anshul<br className='hidden sm:block' /> Tiwari</span>
            </h1>
            <p className='text-[#dfd9ff] font-medium lg:text-[24px] sm:text-[20px] xs:text-[18px] text-[15px] lg:leading-[36px] mt-3 min-h-[40px]'>
              I build{" "}
        ...
        <div className='flex justify-center items-center flex-1 w-full max-w-[450px] md:max-w-none'>
          <motion.div
          ...
          >
            ...
            >
              <img 
                src={anshulPhoto} 
                alt='Anshul Tiwari' 
                className='w-full h-auto object-cover rounded-2xl border-2 border-white/10 shadow-2xl shadow-[#915EFF]/20 max-h-[450px] md:max-h-[500px]'
              />
              {/* Overlay Gradient */}
      ...
      <div className='absolute xs:bottom-10 bottom-5 w-full hidden sm:flex justify-center items-center z-10'>
        <a href='#about'>
